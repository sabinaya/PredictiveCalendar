...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    */
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(CardListView listView, int[] reverseSortedPositions);
    }
     ...
     */
    public SwipeDismissListViewTouchListener(CardListView listView, DismissCallbacks callbacks) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                mDownY = 0;
                mDownView = null;
                mDownPosition = CardListView.INVALID_POSITION;
                if (mSwiping){
